        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <p className="text-zinc-300 font-light leading-relaxed mb-12 max-w-md">
              Whether you are planning a high-end residential alteration or a full-scale commercial remodeling, our team is ready to deliver uncompromising quality.
            </p>

            <div className="space-y-8">
              <div>
                <h4 className="text-xs font-bold tracking-widest text-gold mb-2 uppercase">Head Office</h4>
                <p className="text-taupe font-light">
                  123 Engineering Hub, Level 4<br />
                  Singapore 123456
                </p>
              </div>
              <div>
                <h4 className="text-xs font-bold tracking-widest text-gold mb-2 uppercase">Direct Contact</h4>
                <p className="text-taupe font-light">
                  <a href="mailto:info@ssb.com.sg" className="hover:text-white transition-colors block mb-1">info@ssb.com.sg</a>
                  <span className="hover:text-white transition-colors block">+65 6123 4567</span>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#1a1a1a] p-10 border border-white/5 rounded-sm">
            ...
            {status === "success" ? (
              <div className="bg-gold/10 border border-gold/30 text-gold p-6 rounded-sm">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      name="name" 
                      required 
                      className="w-full bg-[#0a0a0a] border border-[#2a2a2a] text-white px-4 py-3 focus:outline-none focus:border-gold transition-colors rounded-sm"
                    />
                  </div>
                  <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <select 
                    id="sector" 
                    name="sector"
                    className="w-full bg-[#0a0a0a] border border-[#2a2a2a] text-zinc-300 px-4 py-3 focus:outline-none focus:border-gold transition-colors rounded-sm appearance-none"
                  >
                ...
                <div className="space-y-2">
                  ...
                  <textarea 
                    ...
                    rows={5} 
                    required 
                    className="w-full bg-[#0a0a0a] border border-[#2a2a2a] text-white px-4 py-3 focus:outline-none focus:border-gold transition-colors rounded-sm resize-none"
                  ></textarea>
                </div>
                ...
                <button 
                  ...
                  className="w-full bg-gold text-[#0a0a0a] font-bold tracking-widest uppercase py-4 rounded-sm hover:bg-white transition-all duration-300 disabled:opacity-50"
                >
